...
# Option for file upload or manual file path input
...
# Proceed if the dataset is successfully loaded
if 'df' in locals():
    ...
    # Allow users to select columns for clustering
    ...
    st.info("Please provide a dataset to proceed.")
