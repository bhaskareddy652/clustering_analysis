...
# Collect user inputs
user_input = {
    'Birth Rate': st.sidebar.number_input("Birth Rate:", min_value=0.0, max_value=100.00, value=10.0000, step=0.1),
    'CO2 Emission': st.sidebar.number_input("CO2 Emission:", min_value=0.0, max_value=1000.0, value=200.0, step=0.1),
